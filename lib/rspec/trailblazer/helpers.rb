  ...
  module Trailblazer
    module Helpers
      ...
      module Suite
        ...
        def run(params_fragment, invoke: ::Trailblazer::Test::Assertion.method(:invoke_operation), operation: self.operation, **options)
          kws = ::Trailblazer::Test::Suite::Assert.normalize_kws_for_ctx(test: self)
          ctx = ::Trailblazer::Test::Suite::Assert.ctx_for_params_fragment(params_fragment, **kws)
